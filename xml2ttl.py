...
def buildGraph(cs):
    ...
    if conceptScheme.definition:
        ...
        for md in metadata:
            g.add((base_url, SKOS.related, Literal("Folgender Metadatenkatalog wurde verwendet: " + md.cat + " Mit den Definitionen: " + md.d +" Und den Werten: " + md.value)))
        
        g.add((base_url, SKOS.relatedMatch, Literal("https://huaning-yang.github.io/test-repo-core/index.de.html")))
